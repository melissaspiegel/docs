<?php
/**
 * Redux Featured Posts Field Class
 * Short description.
 *
 ...
 *
 * Please be sure to replace ALL instances of "Featured Posts" and "Featured_Posts" with the name of your actual
...
// Don't duplicate me!
if ( ! class_exists( 'Redux_Featured_Posts', false ) ) {
	 ...
	 * @since       1.0.0
	 */
	class Redux_Featured_Posts extends Redux_Field {
		/**
		 * Field Constructor.
		...
		public function enqueue() {
			wp_enqueue_script(
				...
				Redux_Extension_Featured_Posts::$version,
				true
			);
			...
			wp_enqueue_style(
				...
				array(),
				ReduxFramework_Extension_Featured_Posts::$version,
				'all'
			);
		}
	}
